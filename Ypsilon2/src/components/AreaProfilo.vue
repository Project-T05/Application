<template>
    <div>
        ...
        <p style="position: absolute; left: 360px; top:330px;font-size: x-large; font-weight: bold;" >Le tue Statistiche:</p>
        <MyStats style="position: absolute; top:450px; left:350px; " testo="DOMANDE" numero="34"/>
        <MyStats style="position: absolute; top:450px; left:700px; " testo="COMMENTI" numero="34"/>
        <MyStats style="position: absolute; top:450px; left:1050px; " testo="LIKE COMMENTI" numero="34"/>
...
<script>
import MyStats from "../assets/MyStats.vue"
export default {
    components: {
        MyStats
    },
